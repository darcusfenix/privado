...
<div class="container" ng-controller="RegistroController">
    ...
    <div class="fs-form-wrap" id="fs-form-wrap" ng-hide="message">
        <div class="fs-title">
        ...
        <form id="myform" class="fs-form fs-form-full" autocomplete="off">
            ...
            <button class="fs-submit" type="submit" ng-click="registrar()" name="horarioGrupo"
                    id="confirm">Enviar datos</button>
        </form>
    </div>

    <div class="fs-title" ng-show="message">
        <h1 class="sixeMax">Preparaci&oacute;n IPN</h1>

        <h1 ng-show="!error">{{message}}</h1>

        <h1 ng-show="error" style="color:red;">{{message}}</h1>
    </div>
</div><!-- /container -->
