        ...
        <div class="page" id="top">
                            ...
                            <li>
                                ...
                                <ul class="mn-sub mn-has-multi to-left">
                                    <li class="mn-sub-multi">
                                        <ul>
                                            <li>
                                                <a href="pregunta.gsp">Pregunta 1</a>
                                            </li>
                                            <li>
                                                <a href="#">Pregunta 2</a>
                                            </li>
            ...
            <!--section class="page-section" id="about">
                <div class="container relative">
                    <h2 class="section-title font-alt mb-70 mb-sm-40 Bblanco">
                        Elige alguna secci&oacute;n
                    </h2>
                    <div class="row Bblanco">
                        <div class="col-sm-4 mb-xs-30 wow fadeInUp">
                            <div class="team-item">
                                 <div class="team-item-descr font-alt">
                                    ...
                                    <div class="team-item-role mb-20">
                                        20 preguntas
                                    </div>
                                </div>
                                ...
                                <div class="team-item-image">
                                    ...
                                    <img src="images/matematicas.png" alt="" />
                                    
                                    <div class="team-item-detail">
                                        
                                        <h4 class="font-alt normal">Descripci&oacute;n de la secci&oacute;n</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-4 mb-xs-30 wow fadeInUp">
                            <div class="team-item">
                                ...
                                <div class="team-item-image">
                                    ...
                                    <img src="images/ciencias.png" alt="" />
                        ...
                        <div class="col-sm-4 mb-xs-30 wow fadeInUp">
                            <div class="team-item">
                                ...
                                <div class="team-item-image">
                                    ...
                                    <img src="images/comunicacion.png" alt="" />
                                   ...
                                   <div class="table-responsive">
                                        <table class="table table-striped table-hover table-bordered">
                                           ...
                                           <tr>
                                                ...
                                                <td class="alert alert-success align-center">
                                                     Contestada
                                                </td>
                                            </tr>
                                            <tr>
            ...
            <section class="small-section Bguinda mt-40">
                <div class="container relative">
                    ...
                    <div class="align-center">
                        ...
                        <div>
                            <a href="resultado.gsp" class="btn btn-mod btn-w btn-medium btn-round">Resultados</a>
                        </div>
                    </div>
