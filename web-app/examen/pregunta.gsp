            ...
            <section class="page-section">
                <div class="container relative">
                    ...
                    <h5 class="pregunta mb-40 mt-60 mb-sm-40">
                        1. ¿Cuál es el valor de <strong><i>k</i></strong> en la serie 2187(17), <strong><i>k</i></strong>(19), 243(23), 81(29)?
                    </h5>
                    
                    <ul>
                        <li><button type="button" class="respuesta btn btn-default">A) 468</button></li>
                        <li><button type="button" class="respuesta btn btn-default">B) 486</button></li>
                        <li><button type="button" class="respuesta btn btn-default">C) 648</button></li>
                        <li><button type="button" class="respuesta btn btn-default">D) 729</button></li>
                    </ul>
            ...
            <section class="small-section Bguinda mt-40">
                <div class="container relative">
                    ...
                    <div class="align-center">
                        ...
                        <div class="mt-20">
                            <a href="menu.gsp" class="btn btn-mod btn-w btn-medium btn-round">MENU</a>
                        </div>
                    </div>
