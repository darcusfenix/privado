    ...
    <div class="page-header-inner">
        ...
        <div class="page-logo">
            <a href="#" style="margin-top: -12px;">
                <img src="assets/tema/img/logo-pipn.png" alt="logo" class="logo-default"/>
            </a>
                                ...
                                <ul class="dropdown-menu-list scroller" style="height: 275px;"
                                    ...
                                    <li>
                                        <a href="inbox.html?a=view">
                                                <span class="photo">
										<img src="assets/tema/img/avatar2.jpg" class="img-circle" alt="">
										</span>
                                                <span class="subject">
										<span class="from">
										Lisa Wong </span>
                                    ...
                                    <li>
                                        <a href="inbox.html?a=view">
                                                <span class="photo">
										<img src="assets/tema/img/avatar3.jpg" class="img-circle" alt="">
										</span>
                                                <span class="subject">
										<span class="from">
										Richard Doe </span>
                                    ...
                                    <li>
                                        <a href="inbox.html?a=view">
                                                <span class="photo">
										<img src="assets/tema/img/avatar1.jpg" class="img-circle" alt="">
										</span>
                                                <span class="subject">
										<span class="from">
										Bob Nilson </span>
