                ...
                <form name="editAnswer" ng-submit="saveAnswer(editAnswer.$valid, $event)" novalidate
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group"
                             ...
                             ng-show=" answerInstance.typeAnswer === 2">
                        ...
                        <div class="form-group" ng-show="  answerInstance.typeAnswer === 3">
                            <div style="height:300px" class="col-md-10 col-md-offset-1" id="editorContainer"></div>
                        </div>

                        <div class="form-group"
                             ng-show=" answerInstance.typeAnswer === 1">
                        ...
                        <div class="row">
                            <div class="col-md-offset-3 col-md-9">
                                <button type="submit" class="btn green"
                                        ng-disabled="editAnswer.$invalid">Guardar Cambios</button>
                                <a href="#/answer/show/{{answerInstance.id}}" type="button" class="btn default">Cancelar</a>
                            </div>
                        </div>
                    </div>
                </form>
