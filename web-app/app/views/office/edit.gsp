...
<div class="row">
    <div class="col-md-10 col-md-offset-1">
        ...
        <div class="portlet-body form">
            <form name="createOffice" class="form-horizontal" ng-submit="updateOffice(createOffice.$valid, $event)" novalidate>
                <div class="form-body">
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="text-center">
                                <button type="submit" class="btn green" ng-disabled="createOffice.$invalid || !createOffice.$dirty">Actualizar</button>
