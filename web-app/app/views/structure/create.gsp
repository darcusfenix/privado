    ...
    <div class="col-md-8 col-md-offset-2 ">
        ...
        <div class="portlet light bordered" ng-hide="mockExamListList.length === 0">
            ...
            <div class="portlet-body form">
                <form name="createExam" ng-submit="saveMockExam(createExam.$valid, $event)" novalidate
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group"
                             ng-class="{'has-error': createExam.name.$error.required || validator.name.hasError}">
                            ...
                            <div class="col-md-8">
                                ...
                                <span class="help-block"
                                      ng-show="createExam.name.$error.required || validator.name.hasError">
                        ...
                        <div class="form-group"
                             ng-class="{'has-error': createExam.description.$error.required || validator.description.hasError}">
                            ...
                            <div class="col-md-8">
                                ...
                                <span class="help-block"
                                      ng-show="createExam.description.$error.required || validator.description.hasError">
                            ...
                            <div class="row">
                                <div class="col-md-offset-3 col-md-9">
                                    <button type="submit" class="btn green"
                                            ng-disabled="!(varSlc !=0) || createExam.$invalid">Guardar Examen</button>
