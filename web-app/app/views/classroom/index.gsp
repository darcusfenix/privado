            ...
            <div class="portlet-body table-responsive table-scrollable">
                <table class="table table-striped table-bordered table-hover" id="tabla">
                    ...
                    <tr>
                        ...
                        <th>
                            <input type="text" ng-model="filtro.typeClassroom"
                                   placeholder="Filtrar por tipo de alumnos">
                        </th>
                        <th>
                    ...
                    <tr ng-repeat="classroom in classroomList|filter:filtro">
                        <td class="text-center"><a href="#/classroom/show/{{classroom.id}}">{{classroom.nameOffice}}</a>
                        </td>
                        <td class="text-center"><a href="#/classroom/show/{{classroom.id}}">{{classroom.period}}</a>
                        </td>
                        ...
                        <td><span
                                ng-class="classroom.idStateClassroom != 2 ? 'text-success' : 'text-danger'">{{classroom.nameStateClassroom}}</span>
                        </td>
                    </tr>
                    </tbody>
                </table>
