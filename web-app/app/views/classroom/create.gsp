                ...
                <form name="createGroup" class="form-horizontal" ng-submit="saveGroup(createGroup.$valid, $event)"
                    ...
                    <div id="divError" class="form-body">
                        ...
                        <div ng-show="classroomInstance.typeClassroomP == 0">
                            ...
                            <div class="form-group form-md-line-input"
                                 ng-class="{'has-error': createGroup.priority.$error.required||validator.priority.hasError}">
                                <label class="control-label col-md-3"><span class="required">
                                    *</span> Precendencia:
                                </label>
                                ...
                                <div class="col-sm-4">
                                    <span class="text-danger"
                                          ng-show="createGroup.priority.$error.required||validator.priority.hasError">
