    ...
    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <div class="dashboard-stat2">
            ...
            <div class="progress-info">
                <div class="progress">
                    <span class="progress-bar progress-bar-success purple-soft" style="width:{{(classroomInstance.placesOccupied*100)/classroomInstance.places}}%">
                </div>
                <div class="status">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-danger" data-dismiss="modal" ng-click="deleteClassroom();">Eliminar</button>
                                </div>
                            </div>
                            <!-- /.modal-content -->
                        </div>
