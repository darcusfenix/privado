            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="hs-line-4 font-alt ">
                        Curso de preparaci&oacute;n de 2da ronda 2015
                    </div>
                </div>
        ...
        <div class="container relative">
            ...
            <div class="row">
                ...
                <div class="blog-item-body">
                    ...
                    <h1 class="mt-0 naranja font-alt">EXAMEN SIMULACRO</h1>
                    <div class="lead">
                        <p class="">
                            Estimado <b>${user.name} ${user.lastName}</b> estás a punto de comenzar tu examen simulacro.
                        </p>
                        <ul class="">
                            <li>Para iniciar solo da clic en el bot&oacute;n <strong>Comenzar</strong>.</li>
                            <li>La duraci&oacute;n del examen es de 1 hora 20 minutos.</li>
                            <li>Al final del examen podrás visualizar tus resultados y la respuesta correcta de cada pregunta.</li>
                        </ul>
                        <br>
                        <h2 class="mt-0 rojo font-alt">ADVERTENCIA:</h2>
                        <p class="">
                            Te recordamos <strong>solo tienes una oportunidad para realizar tu examen</strong>, una vez iniciado no podrás realizarlo posteriormente.
                        </p>
                    </div>
                </div>

                <h3 class="verde "><strong>Mucho &eacute;xito.</strong></h3>
                <a href="${context}/examen/menu/enrolment?tk=${request.getParameter("tk")}" class="btn col-lg-offset-5 btn-mod mt-50 btn-large btn-round Bazul">COMENZAR</a>
            </div>
        </div>
    </section>
    <hr class="mt-0 mb-0"/>
